...
<main class="main">
    ...
    <div class="bg-2">
        ...
        <div class="box">
            ...
            <button class="button1 button--winona button--border-thick button--round-l button--text-upper button--text-thick"onClick="location.href='NEWS_PHL.jsp'" data-text="뉴스"><span>뉴스 <i class="fa-solid fa-newspaper"></i> </span></button>
